...
function check_errors(){
	...
	if(apply_filters('register_with_captcha', false)){
		if(!apply_filters('register_captcha_verify', $_POST)){
...
<html>
	<head>
		...
		<?php run_hook('register_head_top') ?>
		...
		?>
		<?php run_hook('register_head_bottom') ?>
	</head>
				...
				<div class="container">
					...
					<form action="" method="POST">
						...
						<div class="captcha-container">
							<?php
							if(apply_filters('register_with_captcha', false)){
								echo apply_filters('register_captcha', '');
							} else if(get_setting_value('captcha')){
								?>
								<div class="mb-3">
									<div class="mt-3"></div>
